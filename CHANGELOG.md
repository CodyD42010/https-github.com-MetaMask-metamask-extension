...
## [10.26.0]
### Added
- Add notification for outdated browsers ([#17027](https://github.com/MetaMask/metamask-extension/pull/17027))
...
- Remove unwanted pointer cursor from TransactionDecoding UI ([#17318](https://github.com/MetaMask/metamask-extension/pull/17318))
...
- Update link icon in Home view to the Portfolio dapp ([#17471](https://github.com/MetaMask/metamask-extension/pull/17471))
- Update copy when revoking setApprovalForAll ([#17500](https://github.com/MetaMask/metamask-extension/pull/17500))
- Update menu items to use new icons ([#17468](https://github.com/MetaMask/metamask-extension/pull/17468))
- Update QR code icon in Send flow input ([#17474](https://github.com/MetaMask/metamask-extension/pull/17474))
- Update overview icons for buy, send, and swap actions ([#17492](https://github.com/MetaMask/metamask-extension/pull/17492))
...
- Update Tag icons across the app ([#17540](https://github.com/MetaMask/metamask-extension/pull/17540))
- Update Support icon in the menu ([#17560](https://github.com/MetaMask/metamask-extension/pull/17560))
- Update the Ledger hardware logo ([#17616](https://github.com/MetaMask/metamask-extension/pull/17616))
- Update the Block Explorer icon across the app ([#17562](https://github.com/MetaMask/metamask-extension/pull/17562))
- Sanitizing strings on signature request pages ([#17571](https://github.com/MetaMask/metamask-extension/pull/17571))
- [FLASK] Update onboarding text to fit new panel ([#17345](https://github.com/MetaMask/metamask-extension/pull/17345))
- Swaps: Copy update for Metamask fee tooltip ([#17133](https://github.com/MetaMask/metamask-extension/pull/17133)
- Swaps: Remove notification for falling back from Smart transactions ([#17374](https://github.com/MetaMask/metamask-extension/pull/17374))

### Fixed
- Fix transaction decoding data types `string` and `bool` ([#17299](https://github.com/MetaMask/metamask-extension/pull/17299))
- Fix overlapping text in Activity Tab on Firefox ([#17235](https://github.com/MetaMask/metamask-extension/pull/17235))
- Restore support for Chromium v78 ([#17251](https://github.com/MetaMask/metamask-extension/pull/17251))
- Prevent event error when user presses enter key during onboarding ([#17497](https://github.com/MetaMask/metamask-extension/pull/17497))
- Add navigation between multiple sign prompts and reject all sign prompts ([#17093](https://github.com/MetaMask/metamask-extension/pull/17093))
- Fix RPC URL editing issue of existing networks ([#17451](https://github.com/MetaMask/metamask-extension/pull/17451))
...
- Fix token image not displaying in asset listing ([#17575](https://github.com/MetaMask/metamask-extension/pull/17575))
- [FLASK] remove Snap notifications when it's uninstalled ([#17487](https://github.com/MetaMask/metamask-extension/pull/17487))
...
[Unreleased]: https://github.com/MetaMask/metamask-extension/compare/v10.26.0...HEAD
