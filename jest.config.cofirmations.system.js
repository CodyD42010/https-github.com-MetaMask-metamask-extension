module.exports = {
  collectCoverageFrom: [
    'app/scripts/controllers/transactions/**/*.{js,ts,tsx,jsx}',
    'app/scripts/controllers/decrypt-message.*.{js,ts,tsx,jsx}',
    'app/scripts/lib/AddressBookPetnamesBridge*.{js,ts,tsx,jsx}',
    'app/scripts/lib/SnapsNameProvider*',
    'ui/components/app/desktop-enable-button/**/*.{js,ts,tsx,jsx}',
    'ui/hooks/desktopHooks*.{js,ts,tsx,jsx}',
    'ui/hooks/usePetnamesEnabled.ts',
    'ui/pages/desktop-error/**/*.{js,ts,tsx,jsx}',
    'ui/pages/desktop-pairing/**/*.{js,ts,tsx,jsx}',
    'ui/selectors/approvals*.{js,ts,tsx,jsx}',
    '!**/__tests__/**',
    '!**/*.test.{js,ts,tsx,jsx}',
  ],
